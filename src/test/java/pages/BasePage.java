...
public class BasePage {
     ...
     * Esta clase constructor va a recibir el driver 1 única vez al principio de la ejecución.*/
    ...
    // que devuelva un WebElement nos permite el acceso a todas las funciones de selenium para interacturar con web elements(ejem: clear, click, etc)
    private WebElement Find(String locator){
        return wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(locator)));
    }
 
    // En vez de usar el "click()" normal, usaremos el "clickElement" porque va a estar usando el "Find" el cual va a estar esperando el tiempo que estipulé en BasePage
